...
var gMotionModal = createModal({}, gFormat); // modal group 2 // G0-G3, ...
var gPlaneModal = createModal({onchange:function () {gMotionModal.reset();}}, gFormat); // modal group 10 // G17-19
var gAbsIncModal = createModal({}, gFormat); // modal group 4 // G90-91
var gFeedModeModal = createModal({}, gFormat); // modal group 7 // G93-95
var gUnitModal = createModal({}, gFormat); // modal group 3 // G70-71
var gCycleModal = createModal({}, gFormat); // modal group 16 // G81, ...
