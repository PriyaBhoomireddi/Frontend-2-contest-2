...
function writeRetract() {
  ...
  // special conditions
  var hasHomePositionXY = machineConfiguration.hasHomePositionX() || machineConfiguration.hasHomePositionY();

  // define home positions
  var _xHome;
  var _yHome;
  var _zHome;
  if (false && method == "G28") { // G28 uses home positions
