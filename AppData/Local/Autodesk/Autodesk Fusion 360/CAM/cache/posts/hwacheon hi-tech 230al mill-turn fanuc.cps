/**
  ...
  $Revision: 42854 a0d5d0f05b4d7a75c17cdab986ed64cea3ae3be2 $
  $Date: 2020-08-20 06:13:02 $
...
var gotYAxis = true;
var yAxisMinimum = toPreciseUnit(gotYAxis ? -60.0 : 0, MM); // specifies the minimum range for the Y-axis
var yAxisMaximum = toPreciseUnit(gotYAxis ? 60.0 : 0, MM); // specifies the maximum range for the Y-axis
