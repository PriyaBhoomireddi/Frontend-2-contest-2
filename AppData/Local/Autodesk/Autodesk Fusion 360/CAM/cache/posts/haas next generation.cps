/**
  ...
  $Revision: 43269 1de95a14814dc4bac78be4fc0cf6acc260036d03 $
  $Date: 2021-04-14 23:11:52 $
...
function onRapid(_x, _y, _z) {
  ...
  if (x || y || z) {
    ...
    if (!getProperty("useG0") && !forceG0 && (((x ? 1 : 0) + (y ? 1 : 0) + (z ? 1 : 0)) > 1)) {
      // axes are not synchronized
...
function onRapid5D(_x, _y, _z, _a, _b, _c) {
  ...
  if (!getProperty("useG0") && !forceG0 && ((currentSection.getOptimizedTCPMode() == 0) || (num > 1))) {
    onLinear5D(_x, _y, _z, _a, _b, _c, highFeedrate); // onLinear5D handles inverse time feedrates
    return;
  }
