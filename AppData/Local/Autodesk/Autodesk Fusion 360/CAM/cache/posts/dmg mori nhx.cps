...
properties = {
  ...
  useSmoothing: {
    title: "High accuracy control",
    description: "Enables high-speed, high-accuracy control.",
    type: "boolean",
    value: false,
    scope: "post"
  },
...
function onOpen() {
  ...
  gSmoothing = getProperty("useSmoothingType") == "II" ? 2 : 1;
  rSmoothing = 0;

  if (true) {
    var bAxis;
    if (getProperty("gotContinuousBAxis")) {
      bAxis = createAxis({coordinate:1, table:true, axis:[0, (getProperty("makeBAxisOtherWay") ? -1 : 1) * -1, 0], cyclic:true, preference:1});
    } else {
      bAxis = createAxis({coordinate:1, table:true, axis:[0, (getProperty("makeBAxisOtherWay") ? -1 : 1) * -1, 0], cyclic:true, range:[0, 360]});
...
function onLinear5D(_x, _y, _z, _a, _b, _c, feed) {
  if (!currentSection.isOptimizedForMachine() || !getProperty("gotContinuousBAxis")) {
