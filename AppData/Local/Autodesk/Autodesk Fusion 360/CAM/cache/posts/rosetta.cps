/**
  Copyright (C) 2017-2021 by Autodesk, Inc.
  All rights reserved.
...
legal = "Copyright (C) 2012-2021 Autodesk, Inc.";
...
function onOpen() {
  ...
  // configure for 5 axis table on table VMC (A on X, C on Z)
  if (getProperty("axes") != "3") {
    var aAxis = createAxis({coordinate: 0, table: true, axis: [(getProperty("axes") != "y" ? 1 : 0), (getProperty("axes") == "y" ? 1 : 0), 0], cyclic: true, range: [-90, 90], preference: 0});
    if (getProperty("axes") == "ac") {
      var cAxis = createAxis({coordinate: 2, table: true, axis: [0, 0, 1], cyclic: true, range: [-9999, 9999], preference: 0});
      machineConfiguration = new MachineConfiguration(aAxis, cAxis);
    } else {
      machineConfiguration = new MachineConfiguration(aAxis);
    }

    machineConfiguration.setHomePositionX(toPreciseUnit(0.0, MM));
    machineConfiguration.setHomePositionY(toPreciseUnit(0.0, MM));
