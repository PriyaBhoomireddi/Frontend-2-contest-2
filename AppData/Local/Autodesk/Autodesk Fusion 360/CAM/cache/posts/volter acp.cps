...
// circular output
var iOutput = createReferenceVariable({prefix:"I", force:true}, ijkFormat);
var jOutput = createReferenceVariable({prefix:"J", force:true}, ijkFormat);
var kOutput = createReferenceVariable({prefix:"K", force:true}, ijkFormat);
