...
# this class defines the package Calculator for the Oscillator J-lead Packages.
class PackageCalculatorOscillatorJ(pkg_calculator.PackageCalculator):
	...
	def get_footprint(self):
		...
		toe_goal = ipc_rules.PAD_GOAL_OSCILLATOR_JLEAD['toeFilletMaxMedMin'][self.ui_data['densityLevel']]
		heel_goal = ipc_rules.PAD_GOAL_OSCILLATOR_JLEAD['heelFilletMaxMedMin'][self.ui_data['densityLevel']]
		side_goal = ipc_rules.PAD_GOAL_OSCILLATOR_JLEAD['sideFilletMaxMedMin'][self.ui_data['densityLevel']]
...
pkg_calculator.calc_factory.register_calculator(constant.PKG_TYPE_OSCILLATOR_J, PackageCalculatorOscillatorJ) 