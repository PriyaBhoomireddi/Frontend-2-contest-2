...
CHIP_ARRAY_2SIDE_CONVEX_FAMILY_TYPES = {
...
class PackageCommandChipArray2SideConvex(PackageCommand.PackageCommand):
    def __init__(self, name: str, options: dict):
        super().__init__(name, options)

        #overwrite some specific settings of this command. 
        self.cmd_id = 'cmd_id_chiparray_2side_convex'
        self.cmd_name = _LCLZ('CmdNameChipArray2SideConvex', 'Chip Array, 2 Side Convex Generator')
        self.cmd_description = _LCLZ('CmdDescChipArray2SideConvex', 'Generate Chip Array, 2 Side Convex Packages')
    ...
    def get_defalt_ui_data(self):
        #default parameters
        ui_data = {}
        ui_data['type'] = constant.PKG_TYPE_CHIPARRAY2SIDECONVEX
        ui_data['cmd_id'] = self.cmd_id
        ui_data['componentFamily'] = CHIP_ARRAY_2SIDE_CONVEX_FAMILY_TYPES['RESISTOR']
        ...
        ui_data['verticalPinPitch'] = 0.064
        ui_data['padWidthMax'] = 0.055
        ui_data['padWidthMin'] = 0.035
        ui_data['padHeightMax'] = 0.04
        ui_data['padHeightMin'] = 0.03
        ui_data['oddPadHeightMax'] = 0.055
        ui_data['oddPadHeightMin'] = 0.045
        ui_data['bodyLengthMax'] = 0.34
        ui_data['bodyLengthMin'] = 0.32
        ...
        ui_data['customPadLength'] = 0.116
        ui_data['customPadWidth'] = 0.031
        ui_data['customPadToPadGap'] = 0.1
        ui_data['customOddPadWidth'] = 0.046
    ...
    def update_ui_data(self, inputs):
        ...
        self.ui_data['componentFamily'] = list(CHIP_ARRAY_2SIDE_CONVEX_FAMILY_TYPES.values())[inputs.itemById('componentFamily').selectedItem.index]
    ...
    def on_create(self, command: adsk.core.Command, inputs: adsk.core.CommandInputs):
        ...
        # Create image input.
        labeled_image = tab1_inputs.addImageCommandInput('ChipArray2SideConvexImage', '', "Resources/img/ChipArray-2side-Convex-Labeled.png")
        ...
        for t in CHIP_ARRAY_2SIDE_CONVEX_FAMILY_TYPES:
            component_family_list.add(_LCLZ(t, CHIP_ARRAY_2SIDE_CONVEX_FAMILY_TYPES.get(t)), True if CHIP_ARRAY_2SIDE_CONVEX_FAMILY_TYPES.get(t) == self.ui_data['componentFamily'] else False, '')
        component_family.maxVisibleItems = len(CHIP_ARRAY_2SIDE_CONVEX_FAMILY_TYPES)
        ...
        custom_footprint_image = custom_footprint_inputs.addImageCommandInput('customChipArray2SideConvexImage', '', "Resources/img/ChipArray2SideConvex-Custom-Footprint.png")
...
PackageCommand.cmd_factory.register_command(constant.PKG_TYPE_CHIPARRAY2SIDECONVEX, PackageCommandChipArray2SideConvex) 
