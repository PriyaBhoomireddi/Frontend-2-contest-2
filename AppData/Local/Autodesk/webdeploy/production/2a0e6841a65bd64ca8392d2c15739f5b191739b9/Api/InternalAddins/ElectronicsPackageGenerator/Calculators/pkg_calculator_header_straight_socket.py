...
# this class defines the package Calculator for the Header Straight Socket Packages.
class PackageCalculatorHeaderStraightSocket(pkg_calculator_header.PackageCalculatorHeader):
	...
	def get_ipc_package_description(self):
		family_name = 'Receptacle Header (Female) Straight'
		return super().get_ipc_package_description(family_name)

# register the calculator into the factory. 
pkg_calculator.calc_factory.register_calculator(constant.PKG_TYPE_HEADER_STRAIGHT_SOCKET, PackageCalculatorHeaderStraightSocket) 