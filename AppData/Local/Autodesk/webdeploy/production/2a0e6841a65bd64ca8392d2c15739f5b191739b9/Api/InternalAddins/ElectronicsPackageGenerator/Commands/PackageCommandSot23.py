...
class PackageCommandSot23(PackageCommand.PackageCommand):
    def __init__(self, name: str, options: dict):
        super().__init__(name, options)

        #overwrite some specific settings of this command. 
        self.cmd_id = 'cmd_id_sot23'
        self.cmd_name = _LCLZ('CmdNameSot23', 'SOT23 Generator')
        self.cmd_description = _LCLZ('CmdDescSot23', 'Generate SOT23 Packages')
    ...
    def get_defalt_ui_data(self):
        #default parameters
        ui_data = {}
        ui_data['type'] = constant.PKG_TYPE_SOT23
        ...
        ui_data['verticalPinPitch'] = 0.095
        ui_data['horizontalLeadToLeadSpanMax'] = 0.25
        ui_data['horizontalLeadToLeadSpanMin'] = 0.23
        ui_data['padWidthMax'] = 0.061
        ui_data['padWidthMin'] = 0.045
        ui_data['padHeightMax'] = 0.051
        ui_data['padHeightMin'] = 0.037
        ui_data['bodyLengthMax'] = 0.3
        ui_data['bodyLengthMin'] = 0.28
        ui_data['bodyWidthMax'] = 0.14
        ui_data['bodyWidthMin'] = 0.12
        ui_data['bodyHeightMax'] = 0.11
        ...
        ui_data['customPadWidth'] = 0.118
        ui_data['customPadPitch'] = 0.204
        return ui_data
    ...
    def on_create(self, command: adsk.core.Command, inputs: adsk.core.CommandInputs):
        ...
        # Create image input.
        labeled_image = tab1_inputs.addImageCommandInput('Sot23Image', '', 'Resources/img/SOT23-Labeled.png')
        ...
        custom_footprint_image = custom_footprint_inputs.addImageCommandInput('customSOT23Image', '', 'Resources/img/SOT23-Custom-Footprint.png')
...
PackageCommand.cmd_factory.register_command(constant.PKG_TYPE_SOT23, PackageCommandSot23) 
