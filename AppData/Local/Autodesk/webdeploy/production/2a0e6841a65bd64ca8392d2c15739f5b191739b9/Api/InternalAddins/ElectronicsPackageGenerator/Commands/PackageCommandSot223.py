...
PIN_NUM_OPTIONS = [4,5,6]

class PackageCommandSot223(PackageCommand.PackageCommand):
    def __init__(self, name: str, options: dict):
        super().__init__(name, options)

        #overwrite some specific settings of this command. 
        self.cmd_id = 'cmd_id_sot223'
        self.cmd_name = _LCLZ('CmdNameSot223', 'SOT223 Generator')
        self.cmd_description = _LCLZ('CmdDescSot223', 'Generate SOT223 Packages')
    ...
    def get_defalt_ui_data(self):
        #default parameters
        ui_data = {}
        ui_data['type'] = constant.PKG_TYPE_SOT223
        ui_data['cmd_id'] = self.cmd_id
        ui_data['horizontalPadCount'] = PIN_NUM_OPTIONS[0]
        ...
        ui_data['verticalPinPitch'] = 0.23
        ui_data['horizontalLeadToLeadSpanMin'] = 0.67
        ui_data['horizontalLeadToLeadSpanMax'] = 0.73
        ui_data['padWidthMax'] = 0.11
        ui_data['padWidthMin'] = 0.07
        ui_data['padHeightMax'] = 0.08
        ui_data['padHeightMin'] = 0.06
        ui_data['oddPadHeightMax'] = 0.31
        ui_data['oddPadHeightMin'] = 0.29
        ui_data['bodyLengthMax'] = 0.67
        ui_data['bodyLengthMin'] = 0.63
        ui_data['bodyWidthMax'] = 0.37
        ui_data['bodyWidthMin'] = 0.33
        ui_data['bodyHeightMax'] = 0.18
        ui_data['bodyOffsetMin'] = 0.01
        ...
        ui_data['customPadWidth'] = 0.197
        ui_data['customOddPadLength'] = 0.319
        ui_data['customOddPadWidth'] = 0.197
        ui_data['customPadPitch'] = 0.604
    ...
    def on_create(self, command: adsk.core.Command, inputs: adsk.core.CommandInputs):
        ...
        # Create image input.
        labeled_image = tab1_inputs.addImageCommandInput('Sot223Image', '', 'Resources/img/SOT223-Labeled.png')
        ...
        custom_footprint_image = custom_footprint_inputs.addImageCommandInput('customSOT223Image', '', 'Resources/img/SOT223-Custom-Footprint.png')
...
PackageCommand.cmd_factory.register_command(constant.PKG_TYPE_SOT223, PackageCommandSot223) 
