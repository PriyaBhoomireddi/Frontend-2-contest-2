...
DFN4_FAMILY_TYPES = {
    ...
    'FILTER': constant.COMP_FAMILY_FILTER,
    'IC': constant.COMP_FAMILY_IC,
    'TRANSISTOR': constant.COMP_FAMILY_TRANSISTOR
}

class PackageCommandDFN4(PackageCommand.PackageCommand):
    def __init__(self, name: str, options: dict):
        super().__init__(name, options)

        #overwrite some specific settings of this command. 
        self.cmd_id = 'cmd_id_DFN4'
        self.cmd_name = _LCLZ('CmdNameDFN4', 'DFN-4 Generator')
        self.cmd_description = _LCLZ('CmdDescDFN4', 'Generate DFN-4 Packages')
    ...
    def get_defalt_ui_data(self):
        ...
        ui_data['type'] = constant.PKG_TYPE_DFN4
        ui_data['componentFamily'] = DFN4_FAMILY_TYPES['DIODE']
        ...
        ui_data['horizontalPinPitch'] = 0.075
        ui_data['verticalPinPitch'] = 0.045
        ui_data['padWidthMax'] = 0.04
        ui_data['padWidthMin'] = 0.03
        ui_data['padHeightMax'] = 0.028
        ui_data['padHeightMin'] = 0.023
        ui_data['bodyWidthMax'] = 0.125
        ui_data['bodyWidthMin'] = 0.115
        ui_data['bodyLengthMax'] = 0.08
        ui_data['bodyLengthMin'] = 0.075
        ...
        ui_data['customPadLength'] = 0.046
        ui_data['customPadWidth'] = 0.035
    ...
    def update_ui_data(self, inputs):
        ...
        self.ui_data['componentFamily'] = list(DFN4_FAMILY_TYPES.values())[inputs.itemById('componentFamily').selectedItem.index]
    ...
    def on_create(self, command: adsk.core.Command, inputs: adsk.core.CommandInputs):
        ...
        # Create image input.
        labeled_image = tab1_inputs.addImageCommandInput('DFN4Image', '', 'Resources/img/DFN-4-Labeled.png')
        ...
        for t in DFN4_FAMILY_TYPES:
            component_family_list.add(_LCLZ(t, DFN4_FAMILY_TYPES.get(t)), True if DFN4_FAMILY_TYPES.get(t) == self.ui_data['componentFamily'] else False, '')
        component_family.maxVisibleItems = len(DFN4_FAMILY_TYPES)
        ...
        custom_footprint_image = custom_footprint_inputs.addImageCommandInput('customDFN2Image', '', 'Resources/img/DFN4-Custom-Footprint.png')
...
PackageCommand.cmd_factory.register_command(constant.PKG_TYPE_DFN4, PackageCommandDFN4) 
