...
# this class defines the package Calculator for the SOJ Packages.
class PackageCalculatorSoj(pkg_calculator.PackageCalculator):
	...
	def get_footprint(self):
		...
		toe_goal = ipc_rules.PAD_GOAL_SOJ['toeFilletMaxMedMin'][self.ui_data['densityLevel']]
		heel_goal = ipc_rules.PAD_GOAL_SOJ['heelFilletMaxMedMin'][self.ui_data['densityLevel']]
		side_goal = ipc_rules.PAD_GOAL_SOJ['sideFilletMaxMedMin'][self.ui_data['densityLevel']]
...
pkg_calculator.calc_factory.register_calculator(constant.PKG_TYPE_SOJ, PackageCalculatorSoj) 