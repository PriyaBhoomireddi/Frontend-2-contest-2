...
class Command(Base):
    ...
    def beginStep(self, makeExistingStepNonUndoable):
        """
    ...
    def editingFeature(self, editingFeature):
        """
        Sets the editing feature for this command. The timeline will be rolled to the editing feature on activate and will the current position will be restored on deactivate.
        """
        pass
...
class Palette(Base):
    ...
    def sendInfoToHTML(self, action, data):
        ...
        Returns a string that can be anything that your JavaScript code generates. The JavaScript should always return some content because an empty string is used to indicate a failure. If useNewWebBrowser flag is set to true while creating the palette control this API call will be asynchronous and an empty string is returned. Response will come in data field of HTMLEvent with action equal to 'response'.
        """
        return str()
    def deleteMe(self):
        """
...
class UserInterface(Base):
    ...
    def toolbarTabsByProductType(self, productType):
        ...
        """
        return ToolbarTabList()
    def getText(self, module, id, defaultValue):
        """
        Get the localized text for a specific application text string. The set of text strings are available are listed in the .xml files in the application's StringTable folders.
...
class BoolValueCommandInput(CommandInput):
    ...
    def resourceFolder(self):
        """
        Gets and sets the folder that contains the image to display on the button. Text can also be displayed, which is specified using the text property.
        """
        return str()
    @resourceFolder.setter
    def resourceFolder(self, resourceFolder):
...
class NavigationEventArgs(EventArgs):
    ...
    def navigationURL(self, navigationURL):
        """
        The URL that is being navigated to.
        """
        pass
    @property
    def launchExternally(self):
        """
    ...
    def launchExternally(self, launchExternally):
        """
        If True, the URL will be navigated to in an external browser by the operating system. If False, the default value, the URL will be navigated to in the palette's browser.
        """
        pass
