...
struct VS_TO_PS
{
    ...
    float3 Diff : COLOR0;
    float3 Spec : COLOR1;
    float3 ViewDir : gViewDirection;
    float NormalReversed : NORMAL_REVERSED;
...
float4 minimumRadiusPS(VS_TO_PS IN) : SV_Target
{
...
technique10 MinimumRadius
{
    pass P0
    {
        SetVertexShader(CompileShader(vs_4_0, minimumRadiusVS()));
        SetGeometryShader(NULL);
        SetPixelShader(CompileShader(ps_4_0, minimumRadiusPS()));
    }
}
