...
// The texture.
Texture2D gZebraTex : ZebraTexture
<
    string UIName = "ZebraTexture";
> = NULL;

// Texture sampler.
SamplerState gZebraSamp : ZebraTextureSampler;
...
float4 zebraPS(VS_TO_PS In) : SV_Target
{
    ...
    float3 zebraColor = gZebraTex.Sample(gZebraSamp, UV);
...
technique10 Zebra
{
    pass P0
    {
        SetVertexShader(CompileShader(vs_4_0, zebraVS()));
        SetGeometryShader(NULL);
        SetPixelShader(CompileShader(ps_4_0, zebraPS()));
    }
}
